  ...
  <div class="conteudo-texto">
     ...
     <!--	<h2>Texto</h2> -->     
      ...
      <ul>
        ...
        <li><a href="produtos.php?do=pesquisar&campo=tudo&filtro=qualquer&chave=acessorio">Acess&oacute;rios</a></li>
                <li><a href="produtos.php?do=pesquisar&campo=tudo&filtro=qualquer&chave=usados">Equipamentos Usados</a></li>
      </ul>
