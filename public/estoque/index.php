...
/*if (!isset($_SERVER['PHP_AUTH_USER'])) {
	...
	$login_sql = mysqli_query($conn, "SELECT nome,senha FROM public WHERE id='1'");
	
	while ($l=mysqli_fetch_array($login_sql)) {
		$login_bd = $l["nome"];
		$senha_bd = $l["senha"];
	}
  ...
  <div class="menu">
       ...
       <ul>
		...
		<!--[if lte IE 6]><table><tr><td><![endif]-->        <ul>
            ...
            <li><a href="../produtos.php?do=pesquisar&amp;campo=titulo&amp;filtro=qualquer&amp;chave=acess&oacute;rio">Acess�rios</a></li>
        </ul>
