...
# promocoes.php - pagina de promocoes
...
// numero de promocoes por pagina
...
if ($pagina > 1) {
	...
	$anterior = "<a href=\"promocoes.php?pagina=$prev\">&lt; Anterior</a>";
...
if ($total_paginas > $pagina) {
	...
	$proximo = "<a href=\"promocoes.php?pagina=$next\">Pr&oacute;ximo &gt;</a>";
...
for ($x=1; $x<=$total_paginas; $x++) {
	...
	if ($x==$pagina) { // se estivermos na página corrente, não exibir o link para visualização desta página
	   $n_paginas .= " [$x] ";
		...
		$n_paginas .= " <a href=\"promocoes.php?pagina=$x\">[$x]</a> ";
	}
}
# FIM DA PAGINACAO
...
<div id="contentBox">
	...
	<img src="images/layout/promocoes.png">
	
		<table border="0" cellpadding="20" cellspacing="6" align="center" width="50%" cellpadding="4" cellspacing="10">
		...
		<?php
						...
						if ($total_promo == 0) {
							print("<td align='center'>No momento, n&atilde;o h&aacute; nenhum produto em promo&ccedil;&atilde;o.</td>");
						}
						else {
						# Ha promocoes, exibir produtos
							...
							while ($p=mysql_fetch_array($promocoes_sql)) {
								...
								(isset($thumb) && $thumb != "") ? print('<a href="detalhes.php?pid='.$pid.'"><img src='.$url.$thumb.' title="Ver detalhes de '.$titulo.'" border="0" align="center"></a><br><br>') : print(',<br/><a href="detalhes.php?pid='.$pid.'"><img src="images/sem_imagem.gif" title="Ver detalhes de '.$titulo.'" border="0"></a>');
                   ...
                   ?>
					...
					<tr>
						...
						<td align="center" colspan="2">
							...
							<?php echo $anterior." | ".$n_paginas." | ".$proximo;?> 
